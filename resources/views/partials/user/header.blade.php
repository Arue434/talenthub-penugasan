<nav class="bg-blue-700 rounded-lg border-blue-500 dark:bg-blue-700 relative z-10">
    <div class="container mx-auto flex flex-wrap items-center justify-between p-4 space-x-4">
        <a href="{{ url('/') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-lg md:text-2xl font-semibold whitespace-nowrap dark:text-white text-white">News Talenthub</span>
        </a>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-menu">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-blue-500 rounded-lg bg-blue-700 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-700 dark:bg-blue-700 md:dark:blue-500 dark:border-blue-400">
                <li>
                    <a href="{{ url('/') }}" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-600 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</a>
                </li> <!--dadsada -->
                @foreach ($categories->take(5) as $category)
                    <li>
                        <a href="{{ route('category', ['category' => strtolower($category->name)]) }}" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-600 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">{{ $category->name }}</a>
                    </li>
                @endforeach
                @if ($categories->count() > 5)

                    <li class="relative"> <!--lainnya-->
                        <button class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent flex items-center" id="more-categories-toggle">
                            Lainnya
                ...
                <li class="relative"> <!--region-->
                    <button class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent flex items-center" id="regions-toggle">
                        Regions
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
